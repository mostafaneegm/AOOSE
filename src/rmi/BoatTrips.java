 ...
 * @author hp
 */
public class BoatTrips extends Trips{
    private int ReservationsNumber;

    public BoatTrips(int ReservationsNumber, int ID, int price, String location, String description) throws RemoteException {
