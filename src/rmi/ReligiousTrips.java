 ...
 * @author hp
 */
public class ReligiousTrips extends Trips{
    private int ReservationsNumber;

    public ReligiousTrips(int ReservationsNumber, int ID, int price, String location, String description) throws RemoteException {
